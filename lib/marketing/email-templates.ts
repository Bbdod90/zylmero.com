...
function site() {
  return (
    process.env.NEXT_PUBLIC_SITE_URL?.replace(/\/$/, "") || BRAND_DEFAULT_SITE_URL
  );
}
      ...
      return {
        ...
        html: () =>
          shell(
            ...
            `<p>Je wilde klanten sneller vasthouden. Dat kan met ${BRAND_NAME}: AI die antwoordt, offertes en afspraken opvolgt.</p>
      ...
      return {
        ...
        html: () =>
          shell(
            ...
            `<p>Trage reacties kosten je omzet. ${BRAND_NAME} bundelt berichten, scoort leads en helpt je offertes en afspraken te sluiten.</p>
            <p><a class="btn" href="${s}/dashboard">Open je dashboard</a></p>`,
          ),
      };
    case "drip_3d":
      return {
        subject: `Laatste duw: ${BRAND_NAME} in 10 minuten live`,
        html: () =>
          shell(
