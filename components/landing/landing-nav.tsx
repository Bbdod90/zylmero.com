...
export function LandingNav() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[3.5rem] max-w-[1100px] items-center justify-between gap-3 px-5 sm:px-8">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <ThemeToggle />
          <Button size="sm" className="h-10 rounded-full px-5 text-[13px] font-semibold shadow-sm" asChild>
