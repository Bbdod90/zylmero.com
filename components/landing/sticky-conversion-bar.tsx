...
export function StickyConversionBar() {
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-border/45 bg-card/90 p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] shadow-[0_-12px_40px_-16px_hsl(222_48%_32%/0.08)] backdrop-blur-xl dark:border-white/[0.08] dark:bg-[hsl(228_32%_5%/0.92)] dark:shadow-none md:px-8">
