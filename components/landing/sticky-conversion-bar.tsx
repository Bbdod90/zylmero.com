...
export function StickyConversionBar() {
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-border/30 bg-background/95 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur-md dark:border-white/[0.08] dark:bg-[hsl(228_32%_5%/0.94)] md:px-8">
        <div className="mx-auto flex max-w-[1200px] flex-col gap-3 px-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          <p className="text-center text-sm leading-snug text-muted-foreground sm:text-left">
            Aanvragen niet laten liggen — start gratis of bekijk de demo.
          </p>
