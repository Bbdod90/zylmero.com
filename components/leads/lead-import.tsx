...
export function LeadImport({ disabled }: { disabled: boolean }) {
  ...
  return (
    <div className="cf-dashboard-panel overflow-hidden border-border/60 bg-gradient-to-br from-white via-white to-slate-50/35 dark:from-[hsl(222_30%_13%/0.97)] dark:via-[hsl(222_32%_10%/0.98)] dark:to-[hsl(222_38%_7%/0.99)]">
      <div className="border-b border-border/40 bg-gradient-to-r from-primary/[0.1] via-primary/[0.04] to-transparent px-6 py-5 dark:border-white/[0.06] dark:from-primary/[0.18] dark:via-primary/[0.08] sm:px-7 sm:py-6">
        <div className="flex items-start gap-3">
          <span className="flex size-10 shrink-0 items-center justify-center rounded-xl border border-primary/20 bg-primary/[0.12] text-primary dark:border-primary/35 dark:bg-primary/[0.2]">
      ...
      <div className="space-y-4 p-6 sm:p-7">
        ...
        <Button
          type="button"
          className="rounded-xl bg-gradient-to-r from-primary to-primary/85 px-5 shadow-sm"
